<?php
	...
	public function testSendMessageTrue(){
			...
			$this->assertTrue($mensaje);   //si el resultado es true, la prueba es satisfactoria
        ...
        public function testReadMessageTrue(){
			...
			$this->assertNotNull($mensaje);   //si el resultado no es nulo, la prueba es satisfactoria
